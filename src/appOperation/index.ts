...
export class AppOperation {
  ...
  post(path: string, params: any, type = ADMIN_TYPE) {
    return this.send(path, 'POST', null, params, type);
  }

  put(path: string, params: any, type = ADMIN_TYPE) {
    return this.send(path, 'PUT', null, params, type);
  }

  get(path: string, params: any, data: any, type = ADMIN_TYPE) {
    return this.send(path, 'GET', params, data, type);
  }

  delete(path: string, params: any, type = ADMIN_TYPE) {
